...
function nacionalidad(){
	with(document.datos_p){
		calcularEdad();
		if (nac_eS.value =='E')  {
			res_extS.style.display='block'; 
			res_extS.focus(); 
			document.getElementById('tipoEtq').style.color='#000000';
		} 
		else {
			res_extS.style.display='none'; 
			res_ext.value =''; 
			document.getElementById('tipoEtq').style.color='#D2DEF0';
		}
		//otro campo
		{
		if (nac_eS.value =='E') {
			...
			doc_identS.style.display='none'; 
			doc_ident.value =''; 
			document.getElementById('docEtq').style.color='#D2DEF0';
			}
		}		 
	}
}
