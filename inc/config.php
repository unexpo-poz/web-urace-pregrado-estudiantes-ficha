...
$raizDelSitio		= 'http://'.$_SERVER['SERVER_NAME'].'/web/urace/pregrado/estudiantes/ficha/';
$urlDelSitio		= 'http://www.poz.unexpo.edu.ve/web/urace/';
$tLapso				= 'Lapso 2009-1';
$lapsoProceso		= '2009-1';
$laBitacora			= 'C:/AppServ/www/log/pregrado/estudiantes/ficha_estudiantil_2009-1.log';
$inscHabilitada		= true;
$modoInscripcion	= '1'; // 1: Inscripcion, 2: Inclusion y Retiro

if ($modoInscripcion == '1'){
	$tProceso	= 'Actualizaci&oacute;n de Datos Estudiantiles ';
}
