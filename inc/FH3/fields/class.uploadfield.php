...
class UploadField extends Field
{
    ...
    function getField()
    {
        ...
        // return the field
        return sprintf(
          '<input type="file" name="%s" id="%1$s" %s/>%s',
          $this->_sName,
    ...
    function isValid()
    {
        ...
        elseif($aFile['error'] != 4)
        {
            ...
            else
            {
            	...
            	"Extension of the uploaded file: ".$sExt ."<br />\n".
	            "Mime type of uploaded file: ". $sType ."<br />\n".
	            "Extension known: ".(isset( $aMimeData[$sExt] ) ? "true":"false")."<br />\n".
	            (isset( $aMimeData[$sExt] ) ? "Mime type(s) expected: " . implode(", ", $aMimeData[$sExt]) : '')."<br />\n".
	            "User allowed mime types:<br/>\n<pre>";
