...
fh_conf('FH_LISTFIELD_MASK',
  ...
  "    <tr>\n".
  "      <td align='center'><b>%onlabel%</b></td>\n".
  "      <td align='center'></td>\n".
  "      <td align='center'><b>%offlabel%</b></td>\n".
  "    </tr>\n".
  "    <tr>\n".
...
fh_conf('FH_HELP_MASK',
	...
	src="%s" 
	border="0" 
	onmouseover="return overlib(\'%s\', DELAY, \'400\', FGCOLOR, \'#102781\', BGCOLOR, \'#545b79\', TEXTCOLOR, \'#FFFFFF\', TEXTFONT, \'Verdana\', TEXTSIZE, \'12px\', CELLPAD, 8, BORDER, 1, CAPTION, \'&nbsp;%s\', CAPTIONSIZE, \'12px\');" onmouseout="return nd();" style="color:333333;cursor:help;">'
);
...
// (Overwrites the current date option! It makes the fields empty)
