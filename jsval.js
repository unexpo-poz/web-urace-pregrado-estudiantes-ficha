...
function _jsVal_Language() {
    this.err_form = "Se encontraron errores en los siguientes campos:\n\n";
    this.err_select = "Por favor seleccione un valor correcto en \"%FIELDNAME%\"";
    this.err_enter = "Por favor introduzca un valor correcto en \"%FIELDNAME%\"";
};
